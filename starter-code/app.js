...
// Arrow functions don't have their own "this" - rather the outer context/scope is used to set "this".
// If there is no outer function, then "this" for an arrow function refers to the global object, namely
// the browser window.
